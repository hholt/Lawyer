...
class BottomBarTab(
    ...
    constructor(context: Context, @DrawableRes icon: Int, title: CharSequence) : this(
        context,
        null,
        icon,
        title
    ...
    constructor(context: Context, attrs: AttributeSet?, icon: Int, title: CharSequence) : this(
        context,
        attrs,
        0,
        icon,
    ...
    private fun init(context: Context, icon: Int, title: CharSequence) {
        ...
        val paramsContainer = FrameLayout.LayoutParams(
        ...
        mIcon!!.setColorFilter(
            ContextCompat.getColor(
                context,
                R.color.bottom_navigation_unselected
            )
        )
