...
import com.wl.common.dialog.WaitDialog;
import com.wl.widget.layout.HintLayout;
...
public final class StatusManager {
    ...
    public void showEmpty(View view) {
        showLayout(view, R.drawable.ic_hint_empty, R.string.hint_layout_no_data);
    }
    ...
    public void showError(View view) {
        ...
        if (isNetworkAvailable(view.getContext())) {
            showLayout(view, R.drawable.ic_hint_request, R.string.hint_layout_error_request);
        } else {
            showLayout(view, R.drawable.ic_hint_nerwork, R.string.hint_layout_error_network);
        }
    }
