    ...
    public void layoutVariableViews(final MessageInfo msg, final int position) {
        ...
        if (msg.isSelf()) {
            ...
            if (properties.getRightChatContentFontColor() != 0) {
                ...
                audioTimeText.setTextColor(ContextCompat.getColor(audioTimeText.getContext(), R.color.text_chat_right));
            }
            audioPlayImage.setImageResource(R.drawable.voice_msg_playing_my_3);
            ...
            if (properties.getRightChatContentFontColor() != 0) {
                ...
                audioTimeText.setTextColor(ContextCompat.getColor(audioTimeText.getContext(), R.color.text_chat_left));
            }
        ...
        msgContentFrame.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msg.isSelf()) {
                    audioPlayImage.setImageResource(R.drawable.play_voice_message_my);
                } else {
