...
public class CustomConversationManagerKit implements TIMRefreshListener, MessageRevokedManager.MessageRevokeHandler {

    private final static String TAG = CustomConversationManagerKit.class.getSimpleName();
    ...
    private static CustomConversationManagerKit instance = new CustomConversationManagerKit();

    private CustomConversationProvider mProvider;
    ...
    private CustomConversationManagerKit() {
        init();
    }

    public static CustomConversationManagerKit getInstance() {
        return instance;
    }
    ...
    public void loadConversation(IUIKitCallBack callBack) {
        ...
        if (mProvider == null) {
            mProvider = new CustomConversationProvider();
        }
            ...
            TIMFriendshipManager.getInstance().getUsersProfile(ids, false, new TIMValueCallBack<List<TIMUserProfile>>() {
                ...
                public void onSuccess(List<TIMUserProfile> timUserProfiles) {
                    ...
                    if (profile != null && !TextUtils.isEmpty(profile.getFaceUrl())) {
                        ...
                        face.add(R.drawable.ic_my_avatar);
                    }
                    String title = conversation.getPeer();
