package com.wl.lawyer.im.adapter;
...
import com.wl.lawyer.im.holder.ConversationBaseHolder;
import com.wl.lawyer.im.holder.ConversationCommonHolder;
import com.tencent.qcloud.tim.uikit.modules.conversation.interfaces.IConversationAdapter;
import com.tencent.qcloud.tim.uikit.modules.conversation.interfaces.IConversationProvider;
import com.tencent.qcloud.tim.uikit.utils.ScreenUtil;
import com.wl.lawyer.im.holder.ConversationCustomHolder;
...
public class CustomConversationListAdapter extends IConversationAdapter {
    ...
    public CustomConversationListAdapter() {
    ...
    public void setDataProvider(IConversationProvider provider) {
        ...
        if (provider instanceof CustomConversationProvider) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ConversationInfo.TYPE_CUSTOM) {
            ...
            view = inflater.inflate(R.layout.adapter_conversation_item, parent, false);
    ...
    public ConversationInfo getItem(int position) {
        if (mDataSource.size() == 0)
            return null;
        Log.d("TAG", "getItem: " + mDataSource.size());
